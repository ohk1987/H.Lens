          ...
          <>
            <div className="space-y-3 mb-6">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-[#FEE500] text-[#000000D9] py-3 rounded-xl font-medium hover:bg-[#FDD800] transition"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="#000000D9">
                  <path d="M12 3C6.48 3 2 6.36 2 10.44c0 2.62 1.75 4.93 4.37 6.24-.19.7-.69 2.54-.79 2.94-.12.49.18.49.38.36.15-.1 2.44-1.66 3.43-2.33.52.08 1.06.12 1.61.12 5.52 0 10-3.36 10-7.33S17.52 3 12 3z" />
                </svg>
                카카오로 빠른 가입
              </button>
            </div>
